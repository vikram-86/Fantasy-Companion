...
public protocol StoryboardSceneBased: class{
    ...
    /// The scene indentifier to use when we want to instantiate this ViewController from its associated storyboard
...
public extension StoryboardSceneBased where Self: UIViewController{
    /**
     ...
     and the Scene with identifier 'sceneIdentifier'
